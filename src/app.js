...
const app = async (yargsObj) => {
    ...
    try {
        if (yargsObj.add){
            const movie = new Movie(yargsObj.title, yargsObj.actor, yargsObj.rating, yargsObj.optInfo);
        ...
        else if (yargsObj.searchRating){
            const movie = new Movie(yargsObj.title, yargsObj.actor, yargsObj.rating,  yargsObj.optInfo);
            console.log(await movie.searchRating(collection));
        }
        else {
